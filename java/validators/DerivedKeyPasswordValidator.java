...
public class DerivedKeyPasswordValidator extends PasswordValidationCallback.DerivedKeyPasswordValidator {
    ...
    public boolean validate(Request rqst) throws PasswordValidationException {
        PasswordValidationCallback.PlainTextPasswordRequest plaintTextRequest = (PasswordValidationCallback.PlainTextPasswordRequest) rqst; 
        if("myuserid".equals(plaintTextRequest.getUsername()) && "mypassword".equals(plaintTextRequest.getPassword()))
          return true;
        else
            throw new PasswordValidationCallback.PasswordValidationException("Authentification incorect");
    }
